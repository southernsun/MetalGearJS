# browser-item-pickups Specification

## Purpose
TBD - created by archiving change item-pickups. Update Purpose after archive.
## Requirements
...
The game SHALL run the description path only after a pickup that EMPTIES the room of items (the ROM shows descriptions only for the LAST
